...
NOTE:
    This version of cookiejar.py was added here due to an issue with handling cookies
    with the HTTPOnly flag: https://github.com/python/cpython/pull/17471

    Apart from this note, the file is the original file like specified below:
        https://github.com/python/cpython/commits/master/Lib/http/cookiejar.py
